        ...
        <div className="space-y-4">
          ...
          {isGuestInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow gap-3">
              ...
              <button className="bg-lime-300 flex items-center gap-2 text-lime-950 rounded-lg px-5 py-2 font-medium hover:bg-lime-400">
                Confirmar Viagem
                <ArrowRight className="size-5" />
              </button>
            </div>
          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button onClick={closeGuestModalOpen}>
